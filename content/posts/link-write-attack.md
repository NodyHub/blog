...
draft: true
date: 2024-08-09T29:20:35+02:00
tags:
- attack
- tar
---
...
Let's keep that behavior for now and mind and let us step to the next interesting observation.
...
```
$ go run ./main.go ../alice/alice.tar .
Unarchived ../alice/alice.tar to .
